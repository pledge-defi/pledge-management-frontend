...
export interface PledgePoolEventsContext {
  ...
  SetFee: (
    parameters: {
      filter?: {
        newLendFee?: string | string[];
        newBorrowFee?: string | string[];
      };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
  ...
  SetFeeAddress: (
    parameters: {
      filter?: {
        oldFeeAddress?: string | string[];
        newFeeAddress?: string | string[];
      };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
  ...
  SetMinAmount: (
    parameters: {
      filter?: {
        oldMinAmount?: string | string[];
        newMinAmount?: string | string[];
      };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
  ...
  SetSwapRouterAddress: (
    parameters: {
      filter?: {
        oldSwapAddress?: string | string[];
        newSwapAddress?: string | string[];
      };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
  ...
  StateChange: (
    parameters: {
      filter?: {
        pid?: string | string[];
        beforeState?: string | string[];
        afterState?: string | string[];
      };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
